export class SpeedometerRating extends HTMLElement {
    ...
    private bottomTextPre: string = "";
    private bottomTextAfter: string = "";
    ...
    attributeChangedCallback(name: string, oldVal: string, newVal: string) {
        if (name === 'value') this.value = parseFloat(newVal);
        if (name === 'max') this.max = parseFloat(newVal);
...
export interface SpeedometerRating extends HTMLElement {
}