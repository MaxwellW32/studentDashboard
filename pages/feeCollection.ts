...
function feeCollection() {
    ...
    function generateTable() {
        ...
        const tableHeadingRow = tableHeadingRowTemplate.content.cloneNode(true) as HTMLTableRowElement;

        const tableHeadingCheckbox = getElement<HTMLInputElement>('input[type="checkbox"]', undefined, tableHeadingRow)
