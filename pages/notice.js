...
function makeNoticeBoardItem(eachNoticeBoardItem) {
    const noticeBoardItemTemplate = getElement("#noticeBoardItemTemplate");
    const noticeBoardItemClone = noticeBoardItemTemplate.content.cloneNode(true);
    const noticeBoardItemImage = getElement(".noticeBoardItemImage", undefined, noticeBoardItemClone);
